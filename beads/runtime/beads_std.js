...
export const EF_DIRTY_OR_DERIVED = 131072 | EF_IS_DIRTY;
...
g_enum_ss[FIRST_ENUM + 3] = "px", g_enum_ss[9007194157790523] = "a_find", g_enum_ss[9007191603303728] = "find_start", g_enum_ss[9007192689371859] = "find_len", FIELDS[9007191603303728] = !0, FIELDS[9007192689371859] = !0, 
g_enum_ss[9007192534696881] = "a_find_repl", g_enum_ss[9007193956346111] = "find_patt", g_enum_ss[9007194250103617] = "repl_patt", FIELDS[9007193956346111] = !0, FIELDS[9007193956346111] = !0;
...
export const BIG_END = 9007190873765313;

g_enum_ss[9007190873765313] = "BIG_END";

export const BLENDMODE_ADD = 9007193208486009;

g_enum_ss[9007193208486009] = "BLENDMODE_ADD";

export const BLENDMODE_ALPHA = 9007190010329114;

g_enum_ss[9007190010329114] = "BLENDMODE_ALPHA";

export const BLENDMODE_DARKEN = 9007190800059581;

g_enum_ss[9007190800059581] = "BLENDMODE_DARKEN";

export const BLENDMODE_DIFFERENCE = 9007191076336153;

g_enum_ss[9007191076336153] = "BLENDMODE_DIFFERENCE";

export const BLENDMODE_ERASE = 9007192198043080;

g_enum_ss[9007192198043080] = "BLENDMODE_ERASE";

export const BLENDMODE_HARDLIGHT = 9007190801031541;

g_enum_ss[9007190801031541] = "BLENDMODE_HARDLIGHT";

export const BLENDMODE_INVERT = 9007194240042666;

g_enum_ss[9007194240042666] = "BLENDMODE_INVERT";

export const BLENDMODE_LAYER = 9007191933818223;

g_enum_ss[9007191933818223] = "BLENDMODE_LAYER";

export const BLENDMODE_LIGHTEN = 9007190296892853;

g_enum_ss[9007190296892853] = "BLENDMODE_LIGHTEN";

export const BLENDMODE_MULTIPLY = 9007194046246514;

g_enum_ss[9007194046246514] = "BLENDMODE_MULTIPLY";

export const BLENDMODE_NORMAL = 9007193065834577;

g_enum_ss[9007193065834577] = "BLENDMODE_NORMAL";

export const BLENDMODE_OVERLAY = 9007190118029762;

g_enum_ss[9007190118029762] = "BLENDMODE_OVERLAY";

export const BLENDMODE_SCREEN = 9007191051024702;

g_enum_ss[9007191051024702] = "BLENDMODE_SCREEN";

export const BLENDMODE_SHADER = 9007190653012907;

g_enum_ss[9007190653012907] = "BLENDMODE_SHADER";

export const BLENDMODE_SUBTRACT = 9007191223567846;

g_enum_ss[9007191223567846] = "BLENDMODE_SUBTRACT";

export const BODY_BINARY = 9007190977491561;

g_enum_ss[9007190977491561] = "BODY_BINARY";

export const BODY_HTML = 9007192304658121;

g_enum_ss[9007192304658121] = "BODY_HTML";
...
g_enum_ss[9007194200689272] = "BODY_PLAIN";

export const CAP_BUTT = 9007192063538927;

g_enum_ss[9007192063538927] = "CAP_BUTT";

export const CAP_ROUND = 9007191671167298;

g_enum_ss[9007191671167298] = "CAP_ROUND";

export const CAP_SQUARE = 9007190564166513;

g_enum_ss[9007190564166513] = "CAP_SQUARE";

export const CENTER = 9007192241868086;

g_enum_ss[9007192241868086] = "CENTER";

export const CPU_ARM = 9007190976469578;

g_enum_ss[9007190976469578] = "CPU_ARM";

export const CPU_INTEL = 9007193832875584;

g_enum_ss[9007193832875584] = "CPU_INTEL";
...
FIELDS[F_s_step_size] = !0, FIELDS[F_s_window_size] = !0, FIELDS[F_saturation] = !0, FIELDS[F_sc1] = !0, FIELDS[F_sc2] = !0, FIELDS[F_screen_dpi] = !0, FIELDS[F_screen_horz] = !0, FIELDS[F_screen_vert] = !0, 
FIELDS[F_sop] = !0, FIELDS[F_spt] = !0, FIELDS[F_stop_color] = !0, FIELDS[F_stop_pos] = !0, FIELDS[F_store_autoinc] = !0, FIELDS[F_store_indices] = !0, FIELDS[F_store_name] = !0, FIELDS[F_sysobj] = !0, 
FIELDS[F_top] = !0, FIELDS[F_touch_id] = !0, FIELDS[F_touch_kind] = !0, FIELDS[F_unicode] = !0;

FIELDS[F_unit_factor] = !0, FIELDS[F_unit_to_base] = !0, FIELDS[F_value] = !0, FIELDS[F_vv_canonical] = !0, FIELDS[F_vv_cat] = !0, FIELDS[F_vv_data_xy] = !0, FIELDS[F_vv_default] = !0, FIELDS[F_vv_dim] = !0, 
FIELDS[F_vv_expand] = !0, FIELDS[F_vv_fields] = !0, FIELDS[F_vv_funck] = !0, FIELDS[F_vv_parmk] = !0, FIELDS[F_vv_parmn] = !0, FIELDS[F_vv_parms] = !0, FIELDS[F_vv_rec] = !0, FIELDS[F_vv_typek] = !0, 
FIELDS[F_vv_units] = !0, FIELDS[F_vv_val] = !0, FIELDS[F_when] = !0, FIELDS[F_width] = !0;

FIELDS[F_window_horz] = !0, FIELDS[F_window_vert] = !0, FIELDS[F_x] = !0, FIELDS[F_y] = !0, FIELDS[F_z] = !0;
...
function js_set_screen_size() {
    if (IS_NODE) SCREEN_H = 1024, SCREEN_V = 768, SCREEN_DPI = 96; else {
        let s = window.screen;
        SCREEN_H = s.availWidth, SCREEN_V = s.availHeight, SCREEN_DPI = 96 * window.devicePixelRatio;
    }
    TRACE_BOOT && logg(`SCREEN_H=${SCREEN_H}, SCREEN_V=${SCREEN_V} DPI=${SCREEN_DPI}`), setv(_M, 0, runtime, F_screen_dpi, SCREEN_DPI), setv(_M, 0, runtime, F_screen_horz, SCREEN_H), setv(_M, 0, runtime, F_screen_vert, SCREEN_V);
}
...
export function remote_call(connection, func_name, func_hash, parms) {
    let pos_len, pos_eof, pos_nparms, i, nparms, parmval;
    ...
    bytes_put_card32(gg_buf, func_hash), pos_nparms = gg_buf.position, bytes_put_byte(gg_buf, 0), nparms = 0, i = 0; i < parms.length; ) parmval = parms[i], i += 1, parmval instanceof a_path ? bytes_put_relpath(gg_buf, parmval, socket.client_dest) : bytes_put_val(gg_buf, parmval), 
    logg(`  parm[${i}]=${str.to_str(parmval)}`), nparms += 1;
    bytes_put_byte(gg_buf, SOP_CHUNK_END), pos_eof = gg_buf.position, gg_buf.position = pos_nparms, bytes_put_byte(gg_buf, nparms), gg_buf.position = pos_len, bytes_put_card32(gg_buf, pos_eof - pos_len - 4);
...
export function cursor_custom(arg_image, arg_hotspot, arg_xy) {
    ...
    if (null == tag) draw_image(k.g_root_block, null, arg_image, {
        idss: CURSOR_ID,
        x: netx,
        y: nety,
        shrink: N,
...
export function new_bytes(len, order = BIG_END) {
...
function bytes_put_relpath(buf, argpath, basis) {
    ...
    for (bytes_put_byte(buf, NOV_RELPATH), bytes_put_byte(buf, nlevels), logg(`bytes_put_relpath, nlevels=${nlevels}`), i = 0; i < nlevels; i++) bytes_put_num(buf, argpath.key[basisn + i]);
}

function bytes_get_relpath(buf, basis) {
    var i, subscript, nlevels = bytes_get_byte(buf), net = basis.clone();
    for (i = 0; i < nlevels; i++) subscript = bytes_get_num(buf), net.key.push(subscript);
    return net;
}

export function bytes_put_chunk(buf, ss) {
    for (let i = 0; i < 4; i++) bytes_put_byte(buf, str.from_char(ss.charAt(i)));
    g_fixup_offset = buf.position, bytes_put_card32(buf, 0);
};

export function bytes_fixup_chunk(buf) {
    let pos = buf.position, len = pos - g_fixup_offset;
    buf.position = g_fixup_offset, bytes_put_card32(buf, len), buf.position = pos;
};
...
export function bytes_put_byte(bytes, val) {
...
export function bytes_put_val(buf, val, flag) {
    if (TRACE_ENCODE && 0 != flag && logg("  put_val > skip_pop flag ON"), "number" == typeof val) 0 == val ? (bytes_put_byte(buf, flag | NOV_0), TRACE_ENCODE && logg(str.conv(" put_val, offset={}, ZERO", buf.position))) : val == Y ? (bytes_put_byte(buf, flag | NOV_Y), 
    TRACE_ENCODE && logg(str.conv(" put_val, offset={}, Y", buf.position))) : val == N ? (bytes_put_byte(buf, flag | NOV_N), TRACE_ENCODE && logg(str.conv(" put_val, offset={}, N", buf.position))) : val == U ? (bytes_put_byte(buf, flag | NOV_U), 
    TRACE_ENCODE && logg(str.conv(" put_val, offset={}, U", buf.position))) : Number.isNaN(val) ? (bytes_put_byte(buf, flag | NOV_ERR), TRACE_ENCODE && logg(str.conv(" put_val, offset={}, ERR", buf.position))) : (bytes_put_byte(buf, flag | NOV_NUM), 
    TRACE_ENCODE && logg(str.conv(" put_val, offset={}, num={}", buf.position, val)), bytes_put_num(buf, val)); else if ("string" == typeof val) bytes_put_byte(buf, flag | NOV_STR), TRACE_ENCODE && logg(str.conv(" put_val, offset={}, str={}", buf.position, val)), 
    bytes_put_str(buf, val); else if (val instanceof a_path) bytes_put_byte(buf, flag | NOV_PATH), TRACE_ENCODE && logg(str.conv(" put_val, offset={}, path", buf.position)), bytes_put_path(buf, val); else if (val instanceof a_function) {
        bytes_put_byte(buf, flag | NOV_FUNC), TRACE_ENCODE && logg(str.conv(" put_val, offset={}, func", buf.position)), bytes_put_card32(buf, val.hash);
    } else {
        if (!(val instanceof a_meas)) throw val instanceof a_image ? (bytes_put_byte(buf, flag | NOV_IMAGE), TRACE_ENCODE && logg(str.conv(" put_val, offset={}, image", buf.position)), new Error("not yet")) : val instanceof a_sound ? (bytes_put_byte(buf, flag | NOV_SOUND), 
        TRACE_ENCODE && logg(str.conv(" put_val, offset={}, sound", buf.position)), new Error("not yet")) : (bytes_put_byte(buf, flag | NOV_OBJECT), new Error("not yet"));
        bytes_put_byte(buf, flag | NOV_MEAS), TRACE_ENCODE && logg(str.conv(" put_val, offset={}, meas", buf.position)), bytes_put_num(buf, val.mag), bytes_put_num(buf, val.unit), bytes_put_num(buf, val.family), 
...
export function bytes_put_path(buf, mypath) {
    let mykey;
    for (mykey of (mypath.base instanceof a_tree ? (TRACE_ENCODE && logg(str.conv(" put_path, offset={}, hard hash={}", buf.position, mypath.base.sub)), bytes_put_card32(buf, mypath.base.sub)) : (TRACE_ENCODE && logg(str.conv(" put_path, offset={}, soft hash={}", buf.position, mypath.base)), 
    bytes_put_card32(buf, mypath.base)), bytes_put_byte(buf, mypath.key.length), mypath.key)) bytes_put_val(buf, mykey, 0);
};

export function bytes_get_path(buf) {
    let mypath = new a_path(), hash = bytes_get_card32(buf);
    if (mypath.base = TREES[hash], void 0 == mypath.base) throw new Error("can't resolve path base");
    let kind, nkeys = bytes_get_byte(buf);
    for (let i = 0; i < nkeys; i++) switch (kind = bytes_get_byte(buf)) {
      case NOV_STR:
...
export function bytes_put_tree(buf, subtree) {
    bytes_put_node(buf, path_to_node(subtree)), bytes_put_byte(buf, NOV_EOF);
};

export function bytes_put_node(buf, node) {
    let flag = 0;
    if (0 == (node.eflags & EF_VAL_IS_U) && (null != node.children && (flag = NOPOP), bytes_put_val(buf, node.val, flag)), null != node.children) {
        ...
        bytes_put_num(buf, child.sub), last_sub = child.sub), bytes_put_node(buf, child);
...
export function bytes_put_micro(buf, micro) {
    TRACE_ENCODE && logg(str.conv("  put_micro .when at {}", buf.position)), bytes_put_num(buf, micro.when), bytes_put_str(buf, micro.module), bytes_put_card32(buf, micro.where), bytes_put_card32(buf, micro.kind), 
    bytes_put_path(buf, micro.path), bytes_put_val(buf, micro.oldval, 0), bytes_put_val(buf, micro.newval, 0);
};

export function bytes_put_str(bytes, str) {
    var i, utf8 = [], strlen = str.length;
    for (strlen > 65535 && (strlen = 65535), i = 0; i < strlen; i++) {
    ...
    for (bytes_put_card32(bytes, len8), i = 0; i < len8; i++) bytes.view.setUint8(bytes.position, utf8[i]), bytes.position += 1, bytes.position > bytes.length && (bytes.length = bytes.position);
};

export function bytes_get_val(buf, opcode) {
    let val_meas, val_hash, val_func;
    switch (TRACE_DECODE && logg(str.conv("get_val at {}", buf.position)), opcode) {
      case NOV_NUM:
      ...
      case NOV_FUNC:
        return val_hash = bytes_get_card32(buf), null == (val_func = FUNCS[val_hash]) && CHECKS && internal_err("missing inverse for func"), val_func;
...
export function bytes_get_tree(mod, line, buf, destp) {
    ...
    opcode) {
      case SUB_NUM:
        sub_num = bytes_get_num(buf), dest.key.push(sub_num);
        break;

      case SUB_STR:
        sub_str = bytes_get_str(buf), dest.key.push(sub_str);
        break;
      ...
      default:
        val = bytes_get_val(buf, opcode), TRACE_DECODE && logg(str.conv("  storing value {}, dest={}", val, dest)), setv(mod, line, dest, val), skip_pop || dest.key.pop();
    }
    TRACE_DECODE && logg(str.conv("..end get_tree at {}", buf.position));
};

export function bytes_get_str(bytes) {
    var i, c, char2, char3, len = bytes_get_card32(bytes), out = "";
    for (i = 0; i < len; ) switch (i++, (c = bytes_get_byte(bytes)) >> 4) {
      case 0:
      case 1:
      case 2:
      case 3:
      ...
      case 12:
      case 13:
        char2 = bytes_get_byte(bytes), i++, out += String.fromCharCode((31 & c) << 6 | 63 & char2);
        break;

      case 14:
        char2 = bytes_get_byte(bytes), i++, char3 = bytes_get_byte(bytes), i++, out += String.fromCharCode((15 & c) << 12 | (63 & char2) << 6 | (63 & char3) << 0);
    }
    if (i > len) debugger;
    return out;
};
...
export function bytes_get_byte(bytes) {
...
export function set_ui_language(lang) {
    is_enum_b(lang) ? (setv(_M, 0, runtime, F_ui_language, lang), k.refresh_all()) : internal_err("bad language selection");
};

export function clock_tick() {
    now_raw = sys_rawtime(), elapsed_raw = now_raw - time_launched, now = sys_dilatedime(), elapsed = now - time_launched;
};

export function zap_clock() {
    let raw = sys_rawtime();
    time_launched = raw, now_raw = raw, now = raw, elapsed = 0, elapsed_raw = 0, g_era_raw = raw, g_era_dilated = raw;
};
...
export function coverage(name) {
    inc(_M, 0, addr(runtime, F_code_coverage, name));
};
...
export function debug_write_blackbox(kind, note, mypath) {
    let micro, buf = new_bytes(1e5, BIG_END);
    ...
    bytes_put_tree(buf, addr(runtime, F_major_steps)), bytes_fixup_chunk(buf), bytes_put_chunk(buf, "micr"), bytes_put_card32(buf, g_micro.length), g_micro)) bytes_put_micro(buf, micro);
...
export function subscribe_start(mod, loc, arg_id, arg_url, arg_port, arg_rate, arg_dest, connection, _options) {
    ...
    setv(mod, loc, connection, F_client_bytes_out, 0), sock.onopen = function(evt) {
        ...
        TRACE_CHAN && logg(str.conv(">> on_close, id={}", arg_id)), getn(connection, F_client_status) != CSTATUS_NO_ANSWER && setv(mod, loc, connection, F_client_status, U);
...
function process_client_chunks(mybuf, dest) {
    ...
    if ((opcode = bytes_get_byte(mybuf)) == SOP_CHUNK_START) {
        ...
        var len = bytes_get_int32(mybuf), chunk_start = mybuf.position;
        bigloop: for (;;) switch (opcode = bytes_get_byte(mybuf)) {
          ...
          case SOP_FIRST:
            TRACE_CLIENT && logg("-- opcode SOP_FIRST"), bytes_get_tree(mybuf, dest);
            break;

          case SOP_UPDATE:
            TRACE_CLIENT && logg("-- opcode SOP_UPDATE"), process_deltas(mybuf, dest);
            break;
...
export function process_deltas(buf, dest) {
    for (var opcode, keylen, net, i, keyx, val; TRACE_CLIENT && logg(`top delta loop, pos=${buf.position}`), (opcode = bytes_get_byte(buf)) != SOP_END_DELTA; ) {
        if (opcode != SOP_NODE) {
            debugger;
            break;
        }
        for (keylen = bytes_get_byte(buf), net = dest.clone(), i = 0; i < keylen; i++) keyx = bytes_get_num(buf), net.key.push(keyx);
        val = bytes_get_val(buf), TRACE_CLIENT && logg(str.conv("delta, pos={}, net.key={key}, val={}", buf.position, net.key, val)), path_setv(_M, 0, net, val);
    }
};
...
export function quit(errcode = 0) {
    logg(`inside quit, errorcode=${errcode}`), window.open("", "_parent", ""), window.close();
};

export function debug_where_to_name(targ_mod, targ_line) {
    let node = path_to_node(addr(META, targ_mod, F_mod_funcs));
...
export function debug_jump(targ_major) {
    if (is_numeric(targ_major) != Y) return;
    let curr_stepx, curr_raw, targ_raw, micro, nmicro = g_micro.length, nmajor = tree_count(addr(runtime, F_major_steps));
    if (targ_raw = (targ_major = clamp(Math.round(targ_major), 1, nmajor + 1)) > nmajor ? nmicro : getn(runtime, F_major_steps, targ_major, F_hist_rawx), curr_raw = (curr_stepx = getn(runtime, F_major_stepx)) > nmajor ? nmicro : getn(runtime, F_major_steps, curr_stepx, F_hist_rawx), 
    TRACE_JUMP && logg(str.conv("-- debug_jump, major_step={}, targ_raw={}, curr_raw={}", targ_major, targ_raw, curr_raw)), curr_raw != targ_raw) {
        for (;curr_raw < targ_raw; ) (micro = g_micro[curr_raw]).kind == LOGK_DELTA && (fix_value(micro.path, micro.newval), TRACE_JUMP && logg(str.conv("  forwards step {} at {} from {} to {}", curr_raw, micro.path, micro.oldval, micro.newval))), 
        curr_raw += 1;
        for (;curr_raw > targ_raw; ) (micro = g_micro[curr_raw -= 1]).kind == LOGK_DELTA && (fix_value(micro.path, micro.oldval), TRACE_JUMP && logg(str.conv("  backwards step {} at {} from {} to {}", curr_raw, micro.path, micro.newval, micro.oldval)));
        setv(_M, 0, runtime, F_major_stepx, targ_major);
    }
};
...
export function debug_get_micro(targ_major) {
    ...
    let kind, funcname, ix, rx, start_raw, end_raw, nmicro = g_micro.length, nmajor = tree_count(addr(runtime, F_major_steps));
    if (targ_major = clamp(Math.round(targ_major), 1, nmajor + 1), trunc_tree(_M, 0, addr(runtime, F_micro_steps)), targ_major == U) start_raw = 1, end_raw = nmicro; else {
...
export function debug_clear_future() {
    ...
    let major_sub = major_end - 1, node = path_to_node(addr(runtime, F_major_steps));
...
export function lg(n, _options) {
    let base = E;
    return is_err_enum_b(n) || n < 0 ? ERR : n === U ? U : null !== _options && _options.hasOwnProperty("base") ? (base = _options.base, Number.isNaN(base) || base < 0 ? ERR : base === U ? U : Math.log(n) / Math.log(base)) : Math.log(n);
};
...
export function css_append(css) {
    null != g_style && g_style.parent.removeChild(g_style), (g_style = document.createElement("style")).innerHTML = css, document.head.appendChild(g_style);
};
...
export function os_write_bytes(filename, bytes) {
    var a = document.createElement("a"), data = bytes.arraybuf.slice(0, bytes.position), blob = new Blob([ data ], {
...
export function tree_count(targ) {
    let pathx, node;
    if (targ instanceof a_tree) node = targ, null != k.g_curr_block && node.eflags & NF_STATEFUL && add_node_dependency(node); else if (targ instanceof a_path) {
        if (pathx = path_to_pathx(targ), null != k.g_curr_block && pathx.basepath.base.eflags & NF_STATEFUL && add_pathx_dependency(pathx), null === pathx || !pathx.exists) return 0;
...
export function tree_lo(targ, dependency = !0) {
    let pathx, node, sub;
    if (targ instanceof a_tree) node = targ, dependency && null != k.g_curr_block && node.eflags & NF_STATEFUL && add_node_dependency(node); else if (targ instanceof a_path) {
        if (pathx = path_to_pathx(targ), dependency && null != k.g_curr_block && pathx.basepath.base.eflags & NF_STATEFUL && add_pathx_dependency(pathx), null === pathx || !pathx.exists) return U;
        node = pathx.lev[pathx.lastx].node;
    } else argument_err("expected path or tree");
...
export function tree_index(base, ...sortkeys) {
    let p, result = new a_tree("std", "tree_index");
    g_sortkeys = sortkeys;
    let list = [], myloop = new a_loop({
        across: base
    });
    for (;myloop.next(); ) p = myloop.path.clone(), list.push(p);
    for (p of (list.sort(collate_indirect), list)) append_val(null, 0, p, addr(result));
    return result;
};
...
export function draw_str(container, ss, options) {
    ...
    avail_v = box.height == U ? GIANT_WIDTH : box.height, backcolor !== U && draw_rect(container, {
        ...
        corner: corner,
        pos: 1
    })), avail_h <= 10 || "" == ss || " " == ss) return void (null !== metrics && (setv(_M, 0, metrics, F_x, 0), setv(_M, 0, metrics, F_y, 0)));
    mytxt = document.createElement("div"), is_selectable || (mytxt.style.userSelect = "none", mytxt.style.webkitUserSelect = "none"), mytxt.style.cursor = "", mytxt.style.position = "absolute", mytxt.style.visibility = "hidden", 
...
export function draw_input(container, boxarg, field, options) {
    let start_ss, ss, backcolor = U, bold = !1, border = 2, bordercolor = BLACK, borderempty = TOMATO, box = null, color = BLACK, corner = 0, font = null, hint = "", indent = 0, italic = !1, just = LEFT, leading = U, maxlen = 80, opacity = 1, show_star = !1, show_errs = !0, size = pt_to_dots(container, 10);
    ...
    if (elem.oninput = on_input_change, elem.onblur = on_input_blur, elem.onfocus = on_input_focus, elem.my_field = field, elem.my_show_star = show_star, null == (start_ss = leaf_getv(path_to_pathx(addr(field, F_in_value)), EF_VAL_IS_STR, !1)) && (start_ss = ""), 
...
export function draw_image(container, image, options) {
    ...
    function draw_image2(mytag) {
        ...
        grow || (horz_ratio = min(horz_ratio, 1), vert_ratio = min(vert_ratio, 1)), TRACE_IMG && logg(`  net ratios=${horz_ratio.toFixed(3)}, ${vert_ratio.toFixed(3)}`), horz_size = round(horz_ratio * raw_h), 
        vert_size = round(vert_ratio * raw_v), dest_x = net_boxR.left + (net_boxR.width - horz_size) * horz, dest_y = net_boxR.top + (net_boxR.height - vert_size) * vert, mytag.style.left = `${dest_x.toFixed(0)}px`, 
        mytag.style.top = `${dest_y.toFixed(0)}px`, mytag.style.width = `${horz_size}px`, mytag.style.height = `${vert_size}px`, null != container.can && container.ctx.drawImage(tag, dest_x, dest_y, horz_size, vert_size); else if (null != container.can) {
...
export function draw_rect(container, options) {
    ...
    for (let property in options) switch (property) {
      ...
      case "corner":
        is_numeric(corner_tl = options.corner) !== Y && argument_err("bad corner"), corner_tr = corner_tl, corner_bl = corner_tl, corner_br = corner_tl;
        break;
    ...
    function create_roundrect(mybox) {
        let myshape, ss;
        var left, top, h, v;
        return is_uneven ? (myshape = document.createElementNS(SVG_NS, "path")).setAttribute("d", (left = Math.round(mybox.left), top = Math.round(mybox.top), h = Math.round(mybox.width), v = Math.round(mybox.height), 
        "M " + left + "," + (top + corner_tl) + " A " + corner_tl + " " + corner_tl + " 0 0 1 " + (left + corner_tl) + " " + top + " H " + (left + h - corner_tr) + " A " + corner_tr + " " + corner_tr + " 0 0 1 " + (left + h) + " " + (top + corner_tr) + " V " + (top + v - corner_br) + " A " + corner_br + " " + corner_br + " 0 0 1 " + (left + h - corner_br) + " " + (top + v) + " H " + (left + corner_bl) + " A " + corner_bl + " " + corner_bl + " 0 0 1 " + left + " " + (top + v - corner_bl) + " Z")) : ((myshape = document.createElementNS(SVG_NS, "rect")).setAttribute("x", mybox.left.toFixed(0)), 
        myshape.setAttribute("y", mybox.top.toFixed(0)), myshape.setAttribute("width", mybox.width.toFixed(0)), myshape.setAttribute("height", mybox.height.toFixed(0)), 0 != corner_tl && (ss = corner_tl.toFixed(1), 
...
export function draw_line(container, options) {
    let caps, joint, x1 = U, y1 = U, x2 = U, y2 = U, dx = U, dy = U, angle = null, len = U, color = BLACK, width = 2, opacity = 1, capx = CAP_ROUND, joinx = JOINT_ROUND;
    for (let property in options) switch (property) {
      case "angle":
        angle = options.angle;
        break;
    ...
    if (null != container.can) {
        let ctx = container.ctx;
        return ctx.lineWidth = width, ctx.lineCap = caps, ctx.lineJoin = joint, ctx.strokeStyle = js_color_to_str(color, opacity), ctx.beginPath(), ctx.moveTo(x1, y1), ctx.lineTo(x2, y2), void ctx.stroke();
    }
    let wrapper = js_svg_wrapper(container, 1), shape = document.createElementNS(SVG_NS, "line");
    shape.setAttribute("x1", x1.toFixed(1)), shape.setAttribute("y1", y1.toFixed(1)), shape.setAttribute("x2", x2.toFixed(1)), shape.setAttribute("y2", y2.toFixed(1)), shape.setAttribute("stroke", js_color_to_str(color)), 
    shape.setAttribute("stroke-width", width.toFixed(1)), shape.setAttribute("stroke-linecap", caps), shape.setAttribute("stroke-linejoin", joint), 1 != opacity && shape.setAttribute("opacity", opacity.toFixed(3)), 
    wrapper.appendChild(shape);
};
...
export function draw_polygon(container, polygon, options) {
    ...
    for (polygon instanceof a_path ? poly_path = polygon : polygon instanceof a_tree ? poly_path = addr(polygon) : argument_err("polygon must be a_tree or a_path"), iter = new a_loop({
        across: poly_path
...
export function measure_table_column(b, rowkind, column) {
    let col_ptr = k.tbl_find_rowkind(rowkind, b.tbl.s).fields[column - 1];
...
function gen_db_struct(schema, udb) {
    ...
    let iter = new a_loop({
        across: addr(schema, F_db_stores)
    });
    for (;iter.next(); ) {
        ...
        if (TRACE_FILE && logg(`gen_db_struct checking store ${s_name}`), !udb.objectStoreNames.contains(s_name)) {
            ...
            let dbstore = udb.createObjectStore(s_name, flags), iter2 = new a_loop({
                across: addr(store, F_store_indices)
            });
            for (;iter2.next(); ) {
...
function jsd_to_datetime(jsd) {
    ...
    return setv(_M, 0, result, F_date_second, net_seconds), result;
}
...
function add_select_list(sel, list) {
    ...
    for (;myloop.next(); ) if (exists(list, ix = myloop.index, F_opt_children)) {
        group = document.createElement("optgroup"), option.text = gets(list, ix, F_opt_label), add_select_list(sel, addr(list, ix, F_opt_children));
...
export function js_resize() {
    js_set_screen_size(), k.rebuild_all();
};
...
function js_touchmove(evt) {
    ...
    g_touch.lastx = t.clientX, g_touch.lasty = t.clientY, 25.4 * g_touch.cum_pixels / SCREEN_DPI >= DRAG_THRESHOLD_MM ? g_touch.state = TSTATE_IDLE : elapsed_raw - g_touch.origintime && (k.do_pointer_event(EV_HOLD, elapsed, g_touch.originx, g_touch.originy, g_touch), 
...
function js_touchend(evt) {
    ...
    k.do_pointer_event(EV_TAP, elapsed, g_touch.originx, g_touch.originy, g_touch), event.preventDefault(), event.stopPropagation()), g_touch.state = TSTATE_IDLE);
}
        ...
        if ("input" != target.localName && "select" != target.localName && "textarea" != target.localName) {
            ...
            switch (gg.state) {
              ...
              case TSTATE_AFTER_TOUCH:
                TRACE_CLICK && logg("--- AFTER_TOUCH emit double tap"), k.do_pointer_event(EV_DOUBLE_TAP, elapsed, gg.originx, gg.originy, gg), evt.preventDefault(), evt.stopPropagation();
                break;
...
function js_mouseup(evt) {
    ...
    reset = !1; else {
        ...
        k.do_pointer_event(evkind, elapsed, gg.originx, gg.originy, gg);
    } else gg.state == TSTATE_IN_DRAG && k.do_pointer_event(EV_DRAG_END, elapsed, evt.clientX, evt.clientY, gg);
...
function js_mousemove(evt) {
    ...
    if (null == k.g_root_block) return void (TRACE_MOVE && logg("--js_mousemove ignoring, no root block"));
    if (evt.button >= 3) return;
    var gg = g_mouse[evt.button];
    let distance;
    ...
    distance >= DRAG_THRESHOLD_MM && (gg.state = TSTATE_IN_DRAG, clearTimeout(gg.timer), k.do_pointer_event(EV_DRAG_BEGIN, elapsed, gg.originx, gg.originy, gg), k.do_pointer_event(EV_DRAG_MOVE, elapsed, evt.clientX, evt.clientY, gg), 
    evt.preventDefault())) : gg.state == TSTATE_IDLE ? g_report_hover && (k.do_pointer_event(EV_HOVER, elapsed, evt.clientX, evt.clientY, gg), evt.preventDefault()) : gg.state == TSTATE_IN_DRAG && (k.do_pointer_event(EV_DRAG_MOVE, elapsed, evt.clientX, evt.clientY, gg), 
    evt.preventDefault());
}
...
function js_mouse_timeout(event, gg) {
    if (null != gg) switch (gg.state) {
      case TSTATE_IN_TOUCH:
        g_report_tap_hold ? (TRACE_LOW && logg("  touch timer complete, converting to TAP_HOLD"), k.do_pointer_event(EV_HOLD, elapsed, gg.originx, gg.originy, gg), gg.state = TSTATE_IN_HOLD) : (TRACE_LOW && logg("  touch timer complete, converting to TAP_SINGLE"), 
        k.do_pointer_event(EV_TAP, elapsed, gg.originx, gg.originy, gg), gg.state = TSTATE_IDLE);
        break;

      case TSTATE_AFTER_TOUCH:
        TRACE_LOW && logg("  touch timer complete, emit TAP_SINGLE"), k.do_pointer_event(EV_TAP, elapsed, gg.originx, gg.originy, gg), gg.state = TSTATE_IDLE;
        break;
...
function js_keydown(event) {
    ...
    20 == keycode || 17 == keycode || 18 == keycode || 16 == keycode || 91 == keycode || 92 == keycode ? TRACE_KEYS && logg("--ignoring shift key") : k.do_key_event(elapsed, event.key, keycode, event.shiftKey, event.altKey, event.metaKey, event.ctrlKey) && (TRACE_KEYS && logg("  -- absorbed key event"), 
...
export function new_block(arg_parent, arg_bounds, arg_kind, arg_label, arg_drawer = null, arg_dest = FOR_SCREEN) {
    ...
    newb.style.position = "absolute", arg_label == k.ROOT_BLABEL ? (newb.style.overflow = "hidden", newb.id = arg_label) : arg_label.startsWith("$") ? (newb.style.overlow = "scroll", newb.id = arg_label) : newb.id = arg_label + "_" + g_next_bid.toString(), 
    newb.blabel = arg_label, newb.bid = g_next_bid++, newb.bkind = arg_kind, newb.bseq = 0, newb.locator = 0, newb.dest = arg_dest, null === arg_parent ? (newb.is_modal = !1, newb.dpi = SCREEN_DPI) : (newb.is_modal = arg_parent.is_modal, 
    newb.dpi = arg_parent.dpi, arg_parent.appendChild(newb)), newb.nesting = 0, newb.drawer = arg_drawer, newb.usesz = [], newb.is_measuring = !1, newb.div = null, newb.tbl = null, newb.extra = new a_tree("std", "$a_block.extra"), 
    k.k_set_bounds(newb, arg_bounds), newb;
};
...
export function micro_add_marker(opcode) {
    let rec = {};
    rec.kind = opcode, g_micro.push(rec);
};
...
export function add_major_event(arg_event, absorber) {
    let sx = append_tree(null, 0, arg_event, addr(runtime, F_major_steps));
    if (TRACE_MAJOR) {
        let ss = "null";
...
export function ByteArray(arg_len, arg_order) {
    this.arraybuf = new ArrayBuffer(arg_len), this.view = new DataView(this.arraybuf, 0), this.position = 0, this.little = arg_order != BIG_END;
};
...
export function a_loop(options) {
    ...
    for (let property in options) switch (property) {
      case "across":
        options.across instanceof a_tree ? this.basis = addr(options.across) : options.across instanceof a_path ? this.basis = options.across : argument_err("loop target must be a_path or a_tree"), this.method = METHOD_ACROSS;
        break;
      ...
      case "bottom_up":
        options.bottom_up instanceof a_tree ? this.basis = addr(options.bottom_up) : options.bottom_up instanceof a_path ? this.basis = options.bottom_up : argument_err("loop target must be a path or tree"), 
        this.method = METHOD_BOT_UP;
        break;

      case "recursive":
        options.recursive instanceof a_tree ? this.basis = addr(options.recursive) : options.recursive instanceof a_path ? this.basis = options.recursive : argument_err("loop target must be a path or tree"), 
      ...
      case "top_down":
        options.top_down instanceof a_tree ? this.basis = addr(options.top_down) : options.top_down instanceof a_path ? this.basis = options.top_down : argument_err("loop target must be a path or tree"), this.method = METHOD_TOP_DOWN;
        break;
      ...
      case METHOD_RECURSIVE:
        if (this.base_node = path_to_node(this.basis, !0), null == this.base_node) this.done = !0; else {
            if (this.include_root ? this.state = STATE_EMIT : this.state = STATE_CHILDREN, this.stack_node = [ this.base_node ], this.method == METHOD_RECURSIVE) {
                let field_node = path_to_node(addr(this.base_node, this.recursive_field));
...
a_loop.prototype.update_pos = function() {
    ...
    for (;;) {
        ...
        if (this.state == STATE_CHILDREN) {
            let field_node = path_to_node(addr(this.stack_node[this.stx], this.recursive_field));
...
export function a_tree(arg_mod, arg_label, arg_nodeflags = 0, arg_initval = null) {
    this.children = null, this.val = U, this.eflags = EF_VAL_IS_U | arg_nodeflags, this.seq = 0, this.sub = 0, this.label = arg_label, 0 != (arg_nodeflags & NF_TOPLEVEL) && (this.sub = str.str_hash_fnv(arg_label + ":" + arg_mod), 
    TREES[this.sub] = this), null != arg_initval && merge_tree(arg_mod, 0, arg_initval, addr(this));
};
...
export function a_function(arg_modname = "", arg_name = "", arg_code = null, arg_track = null, arg_parms = null) {
    this.modname = arg_modname, this.name = arg_name, this.code = arg_code, this.tracker = arg_track, this.hash = str.str_hash_fnv(arg_name + ":" + arg_modname), this.parms = arg_parms;
};
...
export function addr(first, ...list) {
...
export function touch(module, loc, path) {
    if (null != path && 0 != (path.base.eflags & NF_STATEFUL)) {
        ...
        if (null != node) {
            if (TRACE_SETVAL && "$" != path.base.sub.substr(0, 1) && logg(str.conv("  touch {}", path)), 0 !== loc) {
...
export function tree_lit(module, loc, ...args) {
    let argx, subscript, val, mytree = new a_tree("std", "$tree_lit"), mypath = addr(mytree), nargs = args.length;
...
export function merge_lit(module, loc, dest, ...args) {
    ...
    for (dest instanceof a_path ? mypath = dest.clone() : dest instanceof a_tree ? mypath = addr(dest) : argument_err("expected a_tree, or a_path"), argx = 0; argx < nargs; ) {
...
export function table_lit(...args) {
    let argx, field, val, fieldx, rowx, mytree = new a_tree("std", "$table_lit"), nargs = args.length, fields = [];
...
export function path_create_pathx(path) {
    ...
    prevlevel.node.children.splice(index, 0, new a_tree("std")), prevlevel.node.children[index].sub = targsub, prevlevel.node.seq = g_currseq + 1, added = !0), lx += 1, (currlevel = px.lev[lx]).sub = targsub, 
...
export function path_to_node(path, depend = !1) {
    ...
    return node = null !== px && px.exists ? px.lev[px.lastx].node : null, depend && null != k.g_curr_block && path.base.eflags & NF_STATEFUL && add_path_dependency(path, node), node;
};
...
export function add_path_dependency(path, node) {
    ...
    dep.path = path.clone(), dep.seq = null != node ? node.seq : 0, TRACE_IMPLIED && logg(str.conv("--adding pathx add_path_dependency: {path} of seq {} in {}", dep.path, dep.seq, k.g_curr_block.blabel)), 
    k.g_curr_block.usesz.push(dep);
};

export function add_pathx_dependency(pathx) {
    let dep = new a_dependency();
    dep.path = pathx.basepath.clone(), pathx.exists ? dep.seq = pathx.lev[pathx.lastx].node.seq : dep.seq = 0, TRACE_IMPLIED && logg(str.conv("--adding pathx dependency: {path} of seq {} in {}", dep.path, dep.seq, k.g_curr_block.blabel)), 
    k.g_curr_block.usesz.push(dep);
};

export function add_node_dependency(node) {
    let dep = new a_dependency();
    dep.path = addr(node), dep.seq = node.seq, TRACE_IMPLIED && logg(str.conv("--adding node dependency: {path} of seq {} in {}", dep.path, dep.seq, k.g_curr_block.blabel)), k.g_curr_block.usesz.push(dep);
};

export function leaf_getv(pathx, expected_type, add_dependency = !0) {
    if (null === pathx) return U_of_type(expected_type);
    if (null != k.g_curr_block && add_dependency && pathx.basepath.base.eflags & NF_STATEFUL && add_pathx_dependency(pathx), !pathx.exists) return U_of_type(expected_type);
...
function setv_x(mod, loc, pathx, newval) {
    ...
    return TRACE_SETVAL && is_stateful && "$" != mybase.sub.substr(0, 1) && logg(changed ? str.conv("  setval {}={}, was {}", pathx, newval, oldval) : str.conv("  setval {}={}, unchanged", pathx, oldval)), 
...
function is_path_in_path(a, b) {
    ...
    let blen = b.key.length, alen = a.key.length;
    if (blen <= alen) return !1;
    for (let i = 0; i < alen; i++) if (a.key[i] != b.key[i]) return !1;
    return !0;
}
...
export function merge_tree(mod, loc, a, b) {
    let src_path;
    if (a instanceof a_path ? src_path = a : a instanceof a_tree ? src_path = addr(a) : argument_err("bad arg"), is_path_eq(src_path, b)) return;
    let temp, tempp, ax = path_to_pathx(src_path);
    if (null === ax || !ax.exists) return;
    let is_logged = src_path.base.eflags & NF_STATEFUL && loc > 0;
    is_logged && micro_add_marker(MARK_MERGE_BEG), (is_path_in_path(src_path, b) || is_path_in_path(b, src_path)) && (tempp = addr(temp = new a_tree("std", "$merge_tree")), merge_tree(_M, 0, src_path, tempp), 
    ax = path_to_pathx(tempp)), merge_x(mod, loc, ax, path_create_pathx(b), 0), is_logged && micro_add_marker(MARK_MERGE_END);
};
...
export function copy_tree(mod, loc, a, b) {
    ...
    if (null === ax || !ax.exists) return;
    let is_logged = src_path.base.eflags & NF_STATEFUL && loc > 0;
    is_logged && micro_add_marker(MARK_COPY_BEG), (is_path_in_path(src_path, b) || is_path_in_path(b, src_path)) && (merge_tree(mod, loc, src_path, tempp = addr(temp = new a_tree("std", "$copy_tree"))), ax = path_to_pathx(tempp));
    let bx = path_to_pathx(b);
    bx.exists ? (trunc_x(mod, loc, bx), merge_x(mod, loc, ax, bx = path_create_pathx(b), 0)) : merge_x(mod, loc, ax, bx = path_create_pathx(b), 0), is_logged && micro_add_marker(MARK_COPY_END);
};
...
export function move_tree(mod, loc, a, b) {
    ...
    is_logged && micro_add_marker(MARK_MOVE_BEG), is_path_in_path(src_path, b) || is_path_in_path(b, src_path) ? (merge_tree(mod, loc, src_path, tempp = addr(temp = new a_tree("std", "$move_tree"))), trunc_x(mod, loc, ax), 
    bx = path_create_pathx(b), merge_x(mod, loc, path_to_pathx(tempp), bx, 0)) : (merge_x(mod, loc, ax, bx = path_create_pathx(b), 0), trunc_x(mod, loc, ax)), is_logged && micro_add_marker(MARK_MOVE_END);
};
...
export function swap_tree(mod, loc, a, b) {
    ...
    tx = path_to_pathx(addr(temp = new a_tree("std", "$swap_tree")));
    let is_logged = (NF_STATEFUL & a.base.eflags || NF_STATEFUL & b.base.eflags) && loc > 0;
    is_logged && micro_add_marker(MARK_SWAP_BEG), merge_x(mod, loc, ax, tx, 0), trunc_x(mod, loc, ax), merge_x(mod, loc, bx, ax = path_create_pathx(a), 0), trunc_x(mod, loc, bx), merge_x(mod, loc, tx, bx = path_create_pathx(b), 0), 
    is_logged && micro_add_marker(MARK_SWAP_END), temp = null, tx = null;
};
...
export function clear_tree(mod, loc, b) {
    ...
    is_logged && micro_add_marker(MARK_CLEAR_BEG), trunc_x(mod, loc, bx), is_logged && micro_add_marker(MARK_CLEAR_END);
};
...
export function trunc_tree(mod, loc, b) {
    ...
    let is_logged = NF_STATEFUL & b.base.eflags && loc > 0;
    is_logged && micro_add_marker(MARK_TRUNC_BEG), trunc_x(mod, loc, bx, !1), is_logged && micro_add_marker(MARK_TRUNC_END);
};
...
function merge_x(mod, loc, ax, bx, nesting) {
    ...
    if ((val = leaf_getv(ax, 0)) != U && setv_x(mod, loc, bx, val), null !== srcnode.children) {
        ...
        nextalev.node = srcnode.children[srcx], nextalev.subx = srcx, nextalev.sub = srcsub, dstx = find_subscript(nextalev.sub, dstnode, 0 == (bx.lev[0].node.eflags & NF_UNSORTED)), g_subscript_found ? nextblev.node = dstnode.children[dstx] : ((newnode = new a_tree("std", "$merge_x")).sub = srcsub, 
...
export function mark_all_instances(field) {
    TRACE_IMPLIED && logg(str.conv("mark_all_instances, deferring all instances of {n}", field)), k.g_fields_to_mark.indexOf(field) < 0 && (k.g_fields_to_mark.push(field), TRACE_IMPLIED && logg(str.conv("  not yet in dirty array, adding {n}", field)));
};
...
export function loom_animate_block(block, reference, targx, targy, duration, curvefunc, funcparm) {
    let a = {}, start_g = k.local_to_global_p(block, new Point(0, 0)), stop_g = k.local_to_global_p(reference, new Point(targx, targy));
...
export function loom_process_events() {
    ...
    elem.prereq === U) if (currtime < elem.time) TRACE_LOOM && logg(str.conv("  loom: waiting for time, elem.time={n3}, currtime={n3}", elem.time, currtime)), lx += 1; else {
        ...
        loom_clearx(lx)) : lx += 1, TRACE_LOOM && logg("loom: about to call trickle"), k.trickle(0), did_trickle = !0;
    } else TRACE_LOOM && logg("  loom: waiting for a prereq"), lx += 1;
    did_trickle || k.trickle(0);
};
...
export function rtl_init() {
    ...
    add_unit(Y_Force, N_lbf, 4.448221618990737), add_unit(Y_Frequency, N_hz, 1), add_unit(Y_Frequency, N_rpm, .016666666666666666), add_unit(Y_Length, N_m, 1), add_unit(Y_Length, N_angstrom, 1e-11), add_unit(Y_Length, N_cm, .01), 
    ...
    var os_ver = get_os_version(navigator.appVersion);
