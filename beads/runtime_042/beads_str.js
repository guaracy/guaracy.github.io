...
export function hex_to_color(ss) {
    if (null == ss) return std.ERR;
    var cc = ss.charAt(0);
    if ("#" != cc) return std.ERR;
    for (var color = 0, i = 1; i < 7; i++) color = 16 * color + hexdig_to_num(cc = ss.charAt(i));
    return color;
};
...
export function to_str(val, options = null) {
    let nshort, old_digits, ss, base = 10, currency_cc = "$ ", decimal_cc = ".", digits = std.U, is_autodec = !1, is_autoinc = !1, is_currency = !1, is_human = !1, is_kflag = !1, is_negparen = !1, is_percent = !1, is_posplus = !1, is_thou = !1, is_zerodrop = !0, is_zeropad = !1, language = "ENG", maxlen = 999, minlen = 0, suffix = null, u_cc = "U", thou_cc = ",", units = std.U;
    ...
    is_posplus && val > 0 && (minlen -= 1), val === std.U || null == val) ss = u_cc, is_zeropad = !1; else if ("string" == typeof val) ss = '"' + val + '"'; else if (val instanceof std.a_meas) {
...
export function str_add_meta() {
    ...
    std.merge_lit(_M, 0, std.META, "str", std.F_mod_funcs, "base64_to_bytes", std.F_vv_cat, VAL, "Strings|Conversions|convert a base64 string into bytes", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "s|string to convert", std.F_vv_typek, VAL, std.TYPE_STR, POP, POP, std.F_vv_typek, VAL, std.TYPE_BYTES, POP, "bytes_to_base64", std.F_vv_cat, VAL, "Strings|Conversions|convert from byte array to base64 string", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "buf|array of bytes to convert", std.F_vv_typek, VAL, std.TYPE_BYTES, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "color_to_hex", std.F_vv_cat, VAL, "Strings|Conversions|convert a color into its HTML hex form #AABBCC", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "c|input color", std.F_vv_typek, VAL, std.TYPE_COLOR, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "from_char", std.F_vv_cat, VAL, "Strings|Conversions|convert a character to its numeric value", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "char|first character in string is used", std.F_vv_typek, VAL, std.TYPE_STR, POP, POP, std.F_vv_typek, VAL, std.TYPE_NUM, POP, "hex_to_num", std.F_vv_cat, VAL, "Strings|Conversions|convert a 16 character hex string into a num", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "ss|16 character string", std.F_vv_typek, VAL, std.TYPE_STR, POP, POP, std.F_vv_typek, VAL, std.TYPE_NUM, POP, "join_words", std.F_vv_cat, VAL, "Strings|Splitting|join an array of words", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "list", std.F_vv_typek, VAL, std.TYPE_ARRAY, POP, 2, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "delim", std.F_vv_typek, VAL, std.TYPE_STR, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "json_to_tree", std.F_vv_cat, VAL, "Strings|Conversions|convert a JSON string back into a tree", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "json|JSON string to convert", std.F_vv_typek, VAL, std.TYPE_STR, POP, 2, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "t|where to store resulting tree", std.F_vv_typek, VAL, std.TYPE_TREE, POP, POP, POP, "markdown_to_html", std.F_vv_cat, VAL, "Strings|HTML|decode a markdown block into plain HTML", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "input|markdown text to convert", std.F_vv_typek, VAL, std.TYPE_STR, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "num_to_hex", std.F_vv_cat, VAL, "Strings|Conversions|convert a double precision floating point number into 16 character hex string", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "n|input number", std.F_vv_typek, VAL, std.TYPE_NUM, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "pad_left", std.F_vv_cat, VAL, "Strings|Basic|pad a string on the left to a specified length", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "ss|starting string", std.F_vv_typek, VAL, std.TYPE_STR, POP, 2, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "len|target length", std.F_vv_typek, VAL, std.TYPE_NUM, POP, 3, std.F_vv_default, VAL, " ", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "pad|character to pad with", std.F_vv_typek, VAL, std.TYPE_STR, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "pad_right", std.F_vv_cat, VAL, "Strings|Basic|pad a string on the right to a specified length", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "ss|starting string", std.F_vv_typek, VAL, std.TYPE_STR, POP, 2, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "len|target length", std.F_vv_typek, VAL, std.TYPE_NUM, POP, 3, std.F_vv_default, VAL, " ", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "pad|character to pad with", std.F_vv_typek, VAL, std.TYPE_STR, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "safe_for_html", std.F_vv_cat, VAL, "Strings|HTML|replace various metacharacters used in HTML", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "input", std.F_vv_typek, VAL, std.TYPE_STR, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "split_lines", std.F_vv_cat, VAL, "Strings|Splitting|split a string into lines on each line break (\\r, \\n, \\r\\n)", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "buf|starting string", std.F_vv_typek, VAL, std.TYPE_STR, POP, 2, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "result|(OUT) array of lines", std.F_vv_typek, VAL, std.TYPE_ARRAY, POP, POP, POP, "split_lines_words", std.F_vv_cat, VAL, "Strings|Splitting|split a string into 2D array of strings, indexed [lines, words]", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "buf|starting string", std.F_vv_typek, VAL, std.TYPE_STR, POP, 2, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "result|(OUT) array of lines and words", std.F_vv_typek, VAL, std.TYPE_ARRAY2, POP, 3, std.F_vv_default, VAL, "\t", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "delim|single word break character like tab or comma", std.F_vv_typek, VAL, std.TYPE_STR, POP, 4, std.F_vv_default, VAL, "Y", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "quotes|if true, then consider double quotes to allow embedding of LF, strip them", std.F_vv_typek, VAL, std.TYPE_YESNO, POP, POP, POP, "split_words", std.F_vv_cat, VAL, "Strings|Splitting|split a line into words", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "buf|starting string", std.F_vv_typek, VAL, std.TYPE_STR, POP, 2, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "result|(OUT) array of words", std.F_vv_typek, VAL, std.TYPE_ARRAY, POP, 3, std.F_vv_default, VAL, "\t", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "delim|word break character like tab or comma (1 char only)", std.F_vv_typek, VAL, std.TYPE_STR, POP, POP, POP, "str_begins", std.F_vv_cat, VAL, "Strings|Basic|see if string begins with a pattern", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "haystack|big string to check against", std.F_vv_typek, VAL, std.TYPE_STR, POP, 2, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "needle|string to look for", std.F_vv_typek, VAL, std.TYPE_STR, POP, POP, std.F_vv_typek, VAL, std.TYPE_YESNO, POP, "str_del", std.F_vv_cat, VAL, "Strings|Basic|remove characters from a string", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "ss|string to manipulate", std.F_vv_typek, VAL, std.TYPE_STR, POP, 2, std.F_vv_default, VAL, "1", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "from|starting position to delete, 1=first", std.F_vv_typek, VAL, std.TYPE_NUM, POP, 3, std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "to|ending position (inclusive) to delete", std.F_vv_typek, VAL, std.TYPE_NUM, POP, 4, std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "len|number of characters to delete", std.F_vv_typek, VAL, std.TYPE_NUM, POP, 5, std.F_vv_default, VAL, "N", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "rev|count from end?", std.F_vv_typek, VAL, std.TYPE_YESNO, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "str_digit", std.F_vv_cat, VAL, "Strings|Basic|get a numeric digit out of a string", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "ss|string to extract from", std.F_vv_typek, VAL, std.TYPE_STR, POP, 2, std.F_vv_default, VAL, "1", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "from|position of character, 1=first", std.F_vv_typek, VAL, std.TYPE_NUM, POP, 3, std.F_vv_default, VAL, "N", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "rev|count from end?", std.F_vv_typek, VAL, std.TYPE_YESNO, POP, POP, std.F_vv_typek, VAL, std.TYPE_NUM, POP, "str_ends", std.F_vv_cat, VAL, "Strings|Basic|see if string ends with a pattern", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "haystack|big string to check against", std.F_vv_typek, VAL, std.TYPE_STR, POP, 2, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "needle|string to look for", std.F_vv_typek, VAL, std.TYPE_STR, POP, POP, std.F_vv_typek, VAL, std.TYPE_YESNO, POP, "str_find", std.F_vv_cat, VAL, "Strings|Find/Replace|find a pattern in a string", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "haystack|haystack to search", std.F_vv_typek, VAL, std.TYPE_STR, POP, 2, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "needle|either pattern or str (regular expression or plain string to find)", std.F_vv_typek, VAL, std.TYPE_ANY, POP, 3, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "list|(OUT) array of a_find, position/len of the matched string 1..N", std.F_vv_rec, VAL, "a_find", std.F_vv_typek, VAL, std.TYPE_RECORD, POP, 4, std.F_vv_default, VAL, "1", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "start|starting position, 1=first", std.F_vv_typek, VAL, std.TYPE_NUM, POP, 5, std.F_vv_default, VAL, "1", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "reps|max repetitions", std.F_vv_typek, VAL, std.TYPE_NUM, POP, 6, std.F_vv_default, VAL, "N", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "wrap|wrap around search", std.F_vv_typek, VAL, std.TYPE_YESNO, POP, POP, POP, "str_inject", std.F_vv_cat, VAL, "Strings|Find/Replace|inject substrings into another, use $1, $2,.. $9 etc. for markers", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "input", std.F_vv_typek, VAL, std.TYPE_STR, POP, 2, std.F_vv_parmk, VAL, std.PK_REST, std.F_vv_parmn, VAL, "parms", std.F_vv_typek, VAL, std.TYPE_STR, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "str_ins", std.F_vv_cat, VAL, "Strings|Basic|insert characters into a string just once", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "ss|starting string", std.F_vv_typek, VAL, std.TYPE_STR, POP, 2, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "ins|string to insert", std.F_vv_typek, VAL, std.TYPE_STR, POP, 3, std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "to|position to insert in front of 1=first", std.F_vv_typek, VAL, std.TYPE_NUM, POP, 4, std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "del|number of characters to delete while doing the insert", std.F_vv_typek, VAL, std.TYPE_NUM, POP, 5, std.F_vv_default, VAL, "N", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "rev|count from end?", std.F_vv_typek, VAL, std.TYPE_YESNO, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "str_len", std.F_vv_cat, VAL, "Strings|Basic|string length", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "ss|string to count length of", std.F_vv_typek, VAL, std.TYPE_STR, POP, POP, std.F_vv_typek, VAL, std.TYPE_NUM, POP, "str_pos", std.F_vv_cat, VAL, "Strings|Find/Replace|find the first occurance of a pattern in a string", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "haystack|haystack to search", std.F_vv_typek, VAL, std.TYPE_STR, POP, 2, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "needle|either regular expression or plain string to find", std.F_vv_typek, VAL, std.TYPE_ANY, POP, 3, std.F_vv_default, VAL, "1", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "start|starting position, 1=first char", std.F_vv_typek, VAL, std.TYPE_NUM, POP, POP, std.F_vv_typek, VAL, std.TYPE_NUM, POP, "str_repeat", std.F_vv_cat, VAL, "Strings|Basic|repeat a string", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "ss|string to repeat", std.F_vv_typek, VAL, std.TYPE_STR, POP, 2, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "n|number of times to repeat", std.F_vv_typek, VAL, std.TYPE_NUM, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "str_replace", std.F_vv_cat, VAL, "Strings|Find/Replace|find and replace in a string", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "haystack|haystack to search", std.F_vv_typek, VAL, std.TYPE_STR, POP, 2, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "needle|either regular expression or plain string to find", std.F_vv_typek, VAL, std.TYPE_ANY, POP, 3, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "replace|replacement string ($1, $2, etc. refer to matched groups)", std.F_vv_typek, VAL, std.TYPE_STR, POP, 4, std.F_vv_default, VAL, "1", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "start|starting position, 1=first char", std.F_vv_typek, VAL, std.TYPE_NUM, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "str_replace_multiple", std.F_vv_cat, VAL, "Strings|Find/Replace|apply a series of changes to a string", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "haystack|haystack to search", std.F_vv_typek, VAL, std.TYPE_STR, POP, 2, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "changes|array of find/replace operations to perform", std.F_vv_rec, VAL, "a_find_repl", std.F_vv_typek, VAL, std.TYPE_RECORD, POP, 3, std.F_vv_default, VAL, "N", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "trace|write progress to log", std.F_vv_typek, VAL, std.TYPE_YESNO, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "str_reverse", std.F_vv_cat, VAL, "Strings|Basic|reverse a string", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "ss|string to reverse", std.F_vv_typek, VAL, std.TYPE_STR, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "str_strip_quotes", std.F_vv_cat, VAL, "Strings|Basic|strip quotes around a string", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "ss|string to process", std.F_vv_typek, VAL, std.TYPE_STR, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "str_to_enum", std.F_vv_cat, VAL, "Strings|Conversions|convert a string of an enum into its internal value", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "s|enum string", std.F_vv_typek, VAL, std.TYPE_STR, POP, POP, std.F_vv_typek, VAL, std.TYPE_NUM, POP, "str_to_tree", std.F_vv_cat, VAL, "Strings|Conversions|convert a string back into a tree", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "s|string to convert", std.F_vv_typek, VAL, std.TYPE_STR, POP, POP, std.F_vv_typek, VAL, std.TYPE_TREE, POP, "str_trim", std.F_vv_cat, VAL, "Strings|Basic|trim whitespace on either side of a string", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "ss|starting string", std.F_vv_typek, VAL, std.TYPE_STR, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "subset", std.F_vv_cat, VAL, "Strings|Basic|string subset", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "ss|starting string", std.F_vv_typek, VAL, std.TYPE_STR, POP, 2, std.F_vv_default, VAL, "1", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "from|starting position to take from, 1=first", std.F_vv_typek, VAL, std.TYPE_NUM, POP, 3, std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "to|ending position (inclusive)", std.F_vv_typek, VAL, std.TYPE_NUM, POP, 4, std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "len|number of characters to extract", std.F_vv_typek, VAL, std.TYPE_NUM, POP, 5, std.F_vv_default, VAL, "N", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "rev|count from end?", std.F_vv_typek, VAL, std.TYPE_YESNO, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "time_to_str", std.F_vv_cat, VAL, "Strings|Date/Time|convert a date/time to a string", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "format|formatting string", std.F_vv_typek, VAL, std.TYPE_STR, POP, 2, std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "time|unix epoch time in seconds to convert, U uses now()", std.F_vv_typek, VAL, std.TYPE_NUM, POP, 3, std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "city|enum value of the city in question GMT, default is current locale", std.F_vv_typek, VAL, std.TYPE_NUM, POP, 4, std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "lang|language", std.F_vv_typek, VAL, std.TYPE_NUM, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "to_char", std.F_vv_cat, VAL, "Strings|Conversions|convert a number into its character value", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "n|unicode code point", std.F_vv_typek, VAL, std.TYPE_NUM, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "to_lower", std.F_vv_cat, VAL, "Strings|Basic|convert to lowercase", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "ss|string to convert", std.F_vv_typek, VAL, std.TYPE_STR, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "to_num", std.F_vv_cat, VAL, "Strings|Conversions|convert a string containing a number into a number", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "s|string to convert", std.F_vv_typek, VAL, std.TYPE_STR, POP, POP, std.F_vv_typek, VAL, std.TYPE_NUM, POP, "to_str", std.F_vv_cat, VAL, "Strings|Conversions|convert a value into string form", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 10, std.F_vv_default, VAL, "N", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "pos_plus|draw plus in front of positive quantities", std.F_vv_typek, VAL, std.TYPE_YESNO, POP, 11, std.F_vv_default, VAL, "N", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "percent|if Y, add % as suffix, mult by 100", std.F_vv_typek, VAL, std.TYPE_YESNO, POP, 12, std.F_vv_default, VAL, "N", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "zero_pad|if Y, pad with leading zeros to make min. width", std.F_vv_typek, VAL, std.TYPE_YESNO, POP, 13, std.F_vv_default, VAL, "Y", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "zero_drop|if Y, drop trailing zeros after decimal point 3.00 -> 3", std.F_vv_typek, VAL, std.TYPE_YESNO, POP, 14, std.F_vv_default, VAL, "$", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "currency_cc|override default currency of $", std.F_vv_typek, VAL, std.TYPE_STR, POP, 15, std.F_vv_default, VAL, ".", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "decimal_cc|override default decimal point of .", std.F_vv_typek, VAL, std.TYPE_STR, POP, 16, std.F_vv_default, VAL, ",", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "thou_cc|override default thousands symbol", std.F_vv_typek, VAL, std.TYPE_STR, POP, 17, std.F_vv_default, VAL, "U", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "u_cc|what to use when value is U", std.F_vv_typek, VAL, std.TYPE_STR, POP, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "val|value to convert, usually a num type", std.F_vv_typek, VAL, std.TYPE_ANY, POP, 2, std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "dig|U: automatic number of digits after decimal", std.F_vv_typek, VAL, std.TYPE_NUM, POP, 3, std.F_vv_default, VAL, "999", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "max|max number of characters in length", std.F_vv_typek, VAL, std.TYPE_NUM, POP, 4, std.F_vv_default, VAL, "0", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "min|pad on left to this min. length", std.F_vv_typek, VAL, std.TYPE_NUM, POP, 5, std.F_vv_default, VAL, "10", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "base|we support bases 2/8/10/16", std.F_vv_typek, VAL, std.TYPE_NUM, POP, 6, std.F_vv_default, VAL, "N", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "currency|if Y, then show currency character", std.F_vv_typek, VAL, std.TYPE_YESNO, POP, 7, std.F_vv_default, VAL, "N", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "thou|if Y, then insert thousands marks", std.F_vv_typek, VAL, std.TYPE_YESNO, POP, 8, std.F_vv_default, VAL, "N", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "k|if Y, then round to K (1000), M (million), B (billion)", std.F_vv_typek, VAL, std.TYPE_YESNO, POP, 9, std.F_vv_default, VAL, "N", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "neg_paren|draw parenthesis for negative values", std.F_vv_typek, VAL, std.TYPE_YESNO, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "to_upper", std.F_vv_cat, VAL, "Strings|Basic|convert to uppercase", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "ss|string to convert", std.F_vv_typek, VAL, std.TYPE_STR, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "tree_to_json", std.F_vv_cat, VAL, "Strings|Conversions|convert a tree into a JSON-compatible string", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "t|tree to convert", std.F_vv_typek, VAL, std.TYPE_TREE, POP, 2, std.F_vv_default, VAL, "INFINITY", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "limit|number of items to stop after", std.F_vv_typek, VAL, std.TYPE_NUM, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, "tree_to_str", std.F_vv_cat, VAL, "Strings|Conversions|convert a tree into a string", std.F_vv_funck, VAL, std.FK_CALC, std.F_vv_parms, 1, std.F_vv_parmk, VAL, std.PK_POS, std.F_vv_parmn, VAL, "t|tree to convert", std.F_vv_typek, VAL, std.TYPE_TREE, POP, 2, std.F_vv_default, VAL, "INFINITY", std.F_vv_parmk, VAL, std.PK_NAMED, std.F_vv_parmn, VAL, "limit|number of items to stop after", std.F_vv_typek, VAL, std.TYPE_NUM, POP, POP, std.F_vv_typek, VAL, std.TYPE_STR, POP, POP, std.F_mod_recs, "a_find", std.F_vv_cat, VAL, "Strings|Find/Replace|", std.F_vv_fields, "find_len", std.F_vv_typek, VAL, std.TYPE_NUM, POP, "find_start", std.F_vv_typek, VAL, std.TYPE_NUM, POP, POP, POP, "a_find_repl", std.F_vv_cat, VAL, "Strings|Find/Replace|", std.F_vv_fields, "find_patt", std.F_vv_typek, VAL, std.TYPE_PATTERN, POP, "repl_patt", std.F_vv_typek, VAL, std.TYPE_STR);
};