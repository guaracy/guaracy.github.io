...
const TRACE_ANIMATION = !0, TRACE_AUTO = !1, TRACE_BITMAP = !1, TRACE_BLACKBOX = !0, TRACE_BLOCKS = !1, TRACE_BOOT = !1, TRACE_CACHE = !1, TRACE_CAPTURE = !1, TRACE_CHAN = !1, TRACE_CHUNK = !1, TRACE_CLICK = !1, TRACE_CLIENT = !0, TRACE_COLLATE = !1, TRACE_CURVE = !1, TRACE_DEBUG = !0, TRACE_DECODE = !0, TRACE_DINPUT = !1, TRACE_DPI = !1, TRACE_ENCOD_LOW = !1, TRACE_ENCODE = !1, TRACE_ENTER = !1, TRACE_EVENTS = !1, TRACE_EXPLODE = !1, TRACE_EXTRA = !1, TRACE_FILE = !1, TRACE_FIND = !1, TRACE_FINDBX = !1, TRACE_GRID = !1, TRACE_GTOL = !1, TRACE_IMG = !1, TRACE_INPATH = !1, TRACE_INPUT = !1, TRACE_INSERT = !1, TRACE_JUMP = !0, TRACE_K = !1, TRACE_KEYS = !1, TRACE_LOG = !1, TRACE_LOGG = !1, TRACE_LOGGING = !1, TRACE_LOGW = !1, TRACE_LOOM = !1, TRACE_LOW = !1, TRACE_MAJOR = !1, TRACE_MICRO = !1, TRACE_MOVE = !1, TRACE_OBSOLETE = !1, TRACE_PICKER = !1, TRACE_SCROLL = !1, TRACE_SEARCH = !1, TRACE_SEQ = !1, TRACE_SETVAL = !1, TRACE_SOUND = !1, TRACE_SPRITE = !1, TRACE_TBL = !1, TRACE_TEXT = !1, TRACE_TO_VAL_PTR = !1, TRACE_TOUCH = !1, TRACE_TRICKLE = !1, TRACE_UNITX = !1, TRACE_VISIT = !1, TRACE_WRITE = !1, TRACE_XFORM = !1, TRACE_XTRA = !1, TRACE_XY = !1, USES_VIDEO = !1, TRAP_BAD_SUBSCRIPTS = !0, TRAP_ERR = !0, TRAP_TYPE_MISMATCH = !0, TRAP_U = !0, SKIP_ANIMATION = !1, OBBLOCK = "$root", SEND_BUF_SIZE = 5e5, TWO_7 = 128, TWO_15 = 32768, TWO_23 = 8388608, TWO_31 = 2147483648, TWO_16 = 65536, TWO_24 = 16777216, TWO_32 = 4294967296, TWO_40 = 1099511627776, TWO_48 = 281474976710656, TWO_56 = 72057594037927940, FIELD_EMPTY_SYMBOL = "✽", FIELD_EMPTY_COLOR = 14423100, FIELD_BAD_SYMBOL = "⚠️";
...
export function bytes_get_str(bytes) {
    var i, c, char2, char3, len = bytes_get_uv(bytes), out = "";
    for (i = 0; i < len; ) switch (i++, (c = bytes_get_u8(bytes)) >> 4) {
      case 0:
      case 1:
      case 2:
      case 3:
      ...
      case 12:
      case 13:
        char2 = bytes_get_u8(bytes), i++, out += String.fromCharCode((31 & c) << 6 | 63 & char2);
        break;

      case 14:
        char2 = bytes_get_u8(bytes), i++, char3 = bytes_get_u8(bytes), i++, out += String.fromCharCode((15 & c) << 12 | (63 & char2) << 6 | (63 & char3) << 0);
    }
    if (i > len) debugger;
    return out;
};
...
export function debug_blackbox_send(url, port, id, filename, options) {
    var bbox_conn = new a_tree("std", "$debug_blackbox_send", 0);
...
function js_mousemove(evt) {
    ...
    evt.preventDefault())) : gg.state == TSTATE_IDLE ? g_report_hover && (do_pointer_event(EV_HOVER, elapsed, evt.clientX, evt.clientY, gg), evt.preventDefault()) : gg.state == TSTATE_IN_DRAG && (do_pointer_event(EV_DRAG_MOVE, elapsed, evt.clientX, evt.clientY, gg), 
    evt.preventDefault());
}
...
function js_keydown(event) {
    ...
    if (20 == keycode || 17 == keycode || 18 == keycode || 16 == keycode || 91 == keycode || 92 == keycode) TRACE_KEYS && logg("--ignoring shift key"); else if (keycode == KEYCODE_ESC && event.ctrlKey && !(event.shiftKey || event.altKey || event.metaKey)) {
        debug_blackbox_write(aaaa.main_drawer.modname, {
            kind: "CTRL-ESC dump"
...
export function new_block(arg_parent, arg_bounds, arg_kind, arg_label, arg_drawer = null, arg_dest = FOR_SCREEN) {
    ...
    newb.style.position = "absolute", arg_label == ROOT_BLABEL ? (newb.style.overflow = "hidden", newb.id = arg_label) : arg_label.startsWith("$") ? (newb.style.overlow = "scroll", newb.id = arg_label) : newb.id = arg_label + "_" + g_next_bid.toString(), 
...
export function a_function(arg_modname = 0, arg_name = "", arg_code = null, arg_track = null, arg_parms = null) {
    this.modname = arg_modname, this.name = arg_name, this.code = arg_code, this.tracker = arg_track, this.hash = str.str_hash_fnv(arg_name + ":" + MODULES[arg_modname]), this.parms = arg_parms;
};
...
export function tree_lit(module, loc, ...args) {
    let argx, subscript, val, mytree = new a_tree("std", "$tree_lit"), mypath = adr(mytree), nargs = args.length;
...
export function merge_tree(mod, loc, a, b) {
    ...
    is_logged && micro_add_marker(MARK_MERGE_BEG, mod, loc), (is_path_in_path(src_path, b) || is_path_in_path(b, src_path)) && (tempp = adr(temp = new a_tree("std", "$merge_tree")), merge_tree(_M, 0, src_path, tempp), 
...
export function copy_tree(mod, loc, a, b) {
    ...
    if (null === ax || !ax.exists) return;
    let is_logged = src_path.base.eflags & NF_STATEFUL && loc > 0;
    is_logged && micro_add_marker(MARK_COPY_BEG, mod, loc), (is_path_in_path(src_path, b) || is_path_in_path(b, src_path)) && (merge_tree(mod, loc, src_path, tempp = adr(temp = new a_tree("std", "$copy_tree"))), 
...
export function move_tree(mod, loc, a, b) {
    ...
    is_logged && micro_add_marker(MARK_MOVE_BEG, mod, loc), is_path_in_path(src_path, b) || is_path_in_path(b, src_path) ? (merge_tree(mod, loc, src_path, tempp = adr(temp = new a_tree("std", "$move_tree"))), 
...
export function swap_tree(mod, loc, a, b) {
    ...
    tx = path_to_pathx(adr(temp = new a_tree("std", "$swap_tree")));
...
export function rtl_init() {
    ...
    ERR_TREE = new a_tree("std", "ERR_TREE", 0), str.str_add_meta(), loom_history = new a_tree("std", "$loom_history", NF_STATEFUL), runtime = new a_tree("std", "$runtime", NF_STATEFUL), blackbox_runtime = new a_tree(_M, "$blackbox_runtime", NF_STATEFUL), 
...
function do_pointer_event(evkind, evtime, wherex, wherey, touch) {
    ...
    let event = new a_tree(_M, "$do_pointer_event", NF_UNSORTED);
    ...
    touch.mod_alt && setv(_M, WHERE_LOOM, event, F_is_alt, Y), touch.mod_cmd && setv(_M, WHERE_LOOM, event, F_is_cmd, Y), touch.mod_ctl && setv(_M, WHERE_LOOM, event, F_is_ctrl, Y), g_last_majorx = -1, 0 != g_capture_bid) return is_not_ide(g_capture_block) && (TRACE_XY && logg(str.conv(" -- adding major event captured ptr evt, first={}", g_capture_block.blabel)), 
    g_last_majorx = add_major_event(event, null)), TRACE_XY && logg("sending captured event to try_in_block"), try_in_block(g_capture_block, event), void (getn(event, F_evkind) == EV_DRAG_END && release_mouse());
    TRACE_XY && logg(str.conv("about to call visit_all, mouse=({n},{n})", wherex, wherey)), evkind == EV_HOVER && setv(_M, 0, runtime, F_cursor_changed, N), visit_all_containing(g_root_block, wherex, wherey, evkind, event), 
    evkind == EV_HOVER && getn(runtime, F_cursor_changed) != Y && cursor_set(CURS_ARROW);
}
...
export function rebuild_all() {
    ...
    if (firstx == U && (firstx = getn(runtime, F_major_stepx), setv(_M, 0, runtime, F_major_firstx, firstx)), null != (maind = null != aaaa.mon_drawer ? aaaa.mon_drawer : aaaa.main_drawer)) {
        ...
        setv(_M, 0, runtime, F_window_horz, horz), setv(_M, 0, runtime, F_window_vert, vert), TRACE_K && logg(`---\x3e rebuild_all: horz=${horz} x ${vert}`);
